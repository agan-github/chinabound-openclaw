...
## 主要输入
- `performanceInputs` 及其相关上游 artifacts
...
## 协作关系
- 上游：website-publishing, app-mini-program, messaging, social-distribution
- 下游：optimization, assignment-planner, audit-trace

## 默认工作流
读取效果数据 → 诊断问题 → 更新规则、模板与建议
