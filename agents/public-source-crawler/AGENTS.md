...
## 主要输入
- `crawlRequests` 及其相关上游 artifacts
...
- `shared/data/source_registry.json`
- crawler cadence from `deploy/cron/jobs/`
- adapter outputs consumed by downstream tagging agents
